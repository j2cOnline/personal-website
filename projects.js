...
var projects = `<div class="newDiv main-body body">
    <h1 class="projects-header">Web Development</h1>
    <h3>Latest Web Projects</h3>

    <div class="projects-grid-container-web">
        <div></div>
        <div class="projects-grid-item">
            <h2>Magic Touch</h2>
            <a href="#magic-touch-web" target="_blank" class="open-popup-link"><img
                    src="img/projects/magicTouch1_small.jpg" alt=""></a>
            <p>JavaScript slot machine app using Phaser3 framework.</p>
            <div id="magic-touch-web" class="white-popup mfp-hide">
                <h1>Play the Latest Demo</h1><span><a target="_blank" href="https://justincrawfordonline.com/magic-touch/index.html"><h4>Touch to see the what I have so far</h4></a></span>
                     <a target="_blank" href="https://justincrawfordonline.com/magic-touch/index.html"><img class="magic-gif"  src="img/MagicTouchClip.gif" alt="gameplay of magic touch"></a>
                    <p>Still working on this project, one of the goals is making it a PWA.</p>
            </div>
        </div>

        <div class="projects-grid-item">
            <h2>In N Out Diet</h2>
            <a href="#in-n-out" target="_blank" class="open-popup-link"><img
                    src="img/projects/in-n-out-burger.jpg" alt=""></a>
        ...
        <div class="projects-grid-item">
            ...
            <a href="#vue-js" target="_blank" class="open-popup-link"><img
                    src="img/projects/vuejs-logo.jpg" alt=""></a>
    ...
    <h3>My primary focus has been gaming software in the class 2 enviroment. From electronic bingo in various flavors to
        skill base slot machine software.</h3>
    <div class="projects-grid-container">

        <div class="projects-grid-item">
            <h2>Bingo</h2>
            <a href="#24-bingo" class="open-popup-link"><img src="img/projects/wizard24_1_small.jpg" alt=""></a>
            <p>Bonanza style electronic bingo games.</p>
            <div id="24-bingo" class="white-popup mfp-hide">
                <h2>Bonanza style games draw 24 numbers before play. Specifically 5 numbers per column except the
                    middle, which is limited to 4.</h2>
        ...
        <div class="projects-grid-item">
            <h2>Slot Suite</h2>
            <a href="#slot-suite" class="open-popup-link"><img src="img/projects/magicTouch2_small.jpg" alt=""></a>
            ...
            <div id="slot-suite" class="white-popup mfp-hide">
                ...
                <h3>
                    First step into slot machine gaming, this is the latest ongoing project that is growing in east
                    coast markets that
                    require a skill based option. Check out my <span><a
                            href="https://www.youtube.com/playlist?list=PLn5H-IzY7glDhlgN-F-AklHua48Ji4YAO"
                            target="_blank"><i class="fab fa-youtube"></i></a></span> channel for a demo!</h3>
        ...
        <div class="projects-grid-item">
            ...
            <a href="#you-pick" class="open-popup-link"><img src="img/projects/Beach_IntroScreen_UNIVERSAL_small.jpg"
                    alt=""></a>
            ...
            <div id="you-pick" class="white-popup mfp-hide">
                ...
                <h3>After adding the feature into a 24# game, it became very popular. The obvious next step was to make
                    a game centered around that feature.</h3>
        ...
        <div class="projects-grid-item">
            <h2>Live Call</h2>
            <a href="#live-call" class="open-popup-link"><img src="img/projects/lcb2intro_small.jpg" alt=""></a>
            ...
            <div id="live-call" class="white-popup mfp-hide">
                ...
                <h3>The games have many settings for operators like auto daub and forcing the player to call a bingo.
                    The game is connected to a physical bingo ball blower. Contact me for more game specifics.</h3>
        ...
        <div class="projects-grid-item">
            <h2>Logos</h2>
            <a href="#logos" class="open-popup-link"><img src="img/projects/Logo_SweetestThing_small.jpg" alt=""></a>
        ...
        <div class="projects-grid-item">
            <h2>For Fun</h2>
            <a href="#for-fun" class="open-popup-link"><img src="img/projects/robot_small.jpg" alt=""></a>
            <p>Variety of 3d and 2d projects.</p>
            <div id="for-fun" class="white-popup mfp-hide">
                <h2>Various projects for fun, usually playing with new programs and techniques.</h2>
